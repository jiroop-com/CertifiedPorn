...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '0cc4c5caaba84ca38380e9a98585b1e3',
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,email,facebook,reddit,twitter,pinterest,whatsapp,telegram,messenger,linkedin,vkshare,tumblr,line,wechat,qq,weibo', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-KG2ZCDQRDJ', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  NOTION_PROPERTY_NAME: {
    ...
    checkout: process.env.NEXT_PUBLIC_NOTION_PROPERTY_CHECKOUT || 'checkout'
